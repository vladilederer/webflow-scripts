...
<script>
    // Diese Funktion holt alle UTM-Parameter aus der URL
    function getUTMParams() {
        const urlParams = new URLSearchParams(window.location.search);
        const utmParams = {};

        // Überprüfe alle relevanten UTM-Parameter
    ...
    // Diese Funktion leitet zur neuen Seite weiter und fügt die UTM-Parameter an
    function redirectWithUTM() {
        const utmQueryString = getUTMParams();

        if (utmQueryString) {
            // Leite zur neuen URL mit den UTM-Parametern weiter
            window.location.href = `https://www.sales-elements.io/landing/vsl-call?${utmQueryString}`;
        } else {
            // Falls keine UTM-Parameter gefunden werden, leite zur Standard-URL weiter
