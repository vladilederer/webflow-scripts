...
function appendUTMToButtonLinks() {
    // Hole die session-Daten aus dem LocalStorage (nicht sessionStorage)
    let sessionData = localStorage.getItem('session'); // Anstelle von sessionStorage.getItem
    let utmParams = {};
    ...
    if (sessionData) {
        ...
        console.log('Session-Daten nicht im localStorage gefunden.');
    }
