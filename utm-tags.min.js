...
function sendUTMToIframe() {
    ...
    let utmParams = {
        ...
        hsa_ad: sessionStorage.getItem('hsa_ad'),
        hsa_cam: sessionStorage.getItem('hsa_cam'),
        hsa_grp: sessionStorage.getItem('hsa_grp'),
        campaign_id: sessionStorage.getItem('campaign_id'),
        add_id_1: sessionStorage.getItem('add_id_1'),
        add_id_2: sessionStorage.getItem('add_id_2'),
        account_id: sessionStorage.getItem('account_id')
    };

    // Debugging: Zeige die UTM-Parameter an, bevor sie an das iFrame gesendet werden
    console.log('UTM-Parameter aus dem sessionStorage:', utmParams);
