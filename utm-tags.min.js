...
function sendUTMToIframe() {
    ...
    // Wähle das Paperform-iFrame aus
    let iframe = document.querySelector('iframe');
    if (iframe) {
        // Sende die UTM-Parameter mit postMessage an das iFrame
        iframe.contentWindow.postMessage(utmParams, '*');
        console.log('UTM-Parameter wurden an das iFrame gesendet:', utmParams);
    } else {
        console.log('Paperform-iFrame nicht gefunden.');
    }
}
...
window.addEventListener('load', function() {
    console.log('Page fully loaded. Running sendUTMToIframe.');
    sendUTMToIframe();
});
