(() => {
    var R = ({ customFormFields: t = {} }) => {
        let r = {
            ...
            rl_fbc_id: t?.fbc_id || "rl_fbc_id",         // Hinzugefügt
            rl_h_ad_id: t?.h_ad_id || "rl_h_ad_id",      // Hinzugefügt
        },
        m = Object.values(r),
        n = {
            ...
            [r.rl_fbc_id]: e.fbc_id,                     // Hinzugefügt
            [r.rl_h_ad_id]: e.h_ad_id,                   // Hinzugefügt
        };
        return {
    ...
    e = {
        ...
        fbc_id: "fbc_id",                               // Hinzugefügt
        h_ad_id: "h_ad_id",                             // Hinzugefügt
    },
    f = Object.values(e),
    ...
    l = {
        ...
        [e.add_id_2]: "",
        [e.account_id]: "",
        [e.fbc_id]: "",                                 // Hinzugefügt
        [e.h_ad_id]: "",                                // Hinzugefügt
    },
    S = {
    ...
    function E(t) {
        return {
            ...
            [e.fbc_id]: t.get(e.fbc_id),                 // Hinzugefügt
            [e.h_ad_id]: t.get(e.h_ad_id),               // Hinzugefügt
        };
    }
    function D(t) {
        let r = E(t);
    ...
    function x(t) {
        return {
            ...
            [e.fbc_id]: t.get(e.fbc_id) || l[e.fbc_id],   // Hinzugefügt
            [e.h_ad_id]: t.get(e.h_ad_id) || l[e.h_ad_id], // Hinzugefügt
        };
    }
    function O() {
    ...
    function N({ referrer: t = "", sessionExpirationTime: r }) {
        ...
        let u = {
            ...
            [e.fbc_id]: S[e.fbc_id],                     // Hinzugefügt
            [e.h_ad_id]: S[e.h_ad_id],                   // Hinzugefügt
        };
