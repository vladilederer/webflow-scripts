...
// … dein bisheriger Code …
  ...
  // Hier speicherst du session in localStorage:
  localStorage.setItem('session', JSON.stringify({ utmParams: t, sessionExpirationTime: r }));

  // **DIREKT HIER** anhängen:
  appendUTMToCurrentIframe();

// Ende deiner Function
})();
