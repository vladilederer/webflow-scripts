...
function populateUTMFields() {
    ...
    if (iframe) {
        ...
        // Fülle die Hidden Fields im iFrame mit den UTM-Daten
        ...
        console.log('UTM-Daten wurden an die Hidden Fields übergeben:', utmParams);
    } else {
...
window.addEventListener('load', function() {
    console.log('Page fully loaded. Running populateUTMFields.');
    populateUTMFields();
});
