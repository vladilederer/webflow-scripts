...
// Funktion, um alle UTM-Parameter aus der URL zu holen
function getUTMParams() {
    const urlParams = new URLSearchParams(window.location.search);
    const utmParams = {};

    // Überprüfe alle relevanten UTM-Parameter und speichere sie, falls vorhanden
...
// Funktion, um zur nächsten Seite zu leiten und die UTM-Parameter in der URL zu übergeben
function redirectWithUTM() {
    const utmQueryString = getUTMParams();

    if (utmQueryString) {
        // Leite zur nächsten Seite mit den UTM-Parametern in der URL weiter
        window.location.href = `https://www.sales-elements.io/landing/vsl-call?${utmQueryString}`;
    } else {
        // Falls keine UTM-Parameter vorhanden sind, leite zur Standardseite weiter
        window.location.href = 'https://www.sales-elements.io/landing/vsl-call';
    }
}

// Beispiel für die Button-Verlinkung: Hier passt du den Button-Selektor an
document.getElementById('buttonID').addEventListener('click', (e) => {
    e.preventDefault(); // Verhindere die Standardaktion
    redirectWithUTM();  // Rufe die Weiterleitungsfunktion auf
});
